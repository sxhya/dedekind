...
$\xymatrix{ \delta(\omega)\colon N_\omega \ar[r] & \ar@<-1.0ex>[l] N_{-\omega}\colon \delta(-\omega) }$ satisfying the following identity:
...
\xymatrix{ N_\omega \ar[r]_{\delta(\omega)}\ar@{^{(}->}[d] \ar@/^1.5pc/[rr]^{\mathrm{id}} & N_{-\omega} \ar@{^{(}->}[d] \ar[r]_{\delta(-\omega)} & N_\omega \ar@{^{(}->}[d] \\
