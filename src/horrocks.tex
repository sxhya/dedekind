...
\begin{proof}
    ...
    Identity~\eqref{eq:sigma-sigma-minus} can be verified by the same calculation (with $\varpi_k$ and $\Sigma_k^+$ replaced with $-\varpi_k$ and $\Sigma_k^-$).
    Now let us verify~\eqref{eq:sigma-delta}.
\end{proof}
