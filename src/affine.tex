...
Also the coweight $\varpi_k^\vee$ is a \textit{microweight} of the dual root system $\Phi^\vee$, cf. e.\,g.~\cite[\S~2]{Ge17}.
Recall that by definition this means that $(\varpi_k^\vee, \alpha) \in \{ -1, 0, 1 \}$ for all $\alpha \in \Phi$.
