...
Now we are ready to recall the definition of the Steinberg group functor $\St(C, -)$ in the Kac--Moody setting.
In fact, two such definitions have been proposed: the definition of J.~Tits~\cite[\S~3.6]{Ti87} and the definition of J.~Morita and U.~Rehmann~\cite[\S~2]{MR90}.
...
\begin{proof}
    ...
    Now it is straightforward to check that the homomorphism given by $x_{(\alpha, m)}(a) \mapsto x_\alpha(aX^m)$ is an isomorphism with the inverse given by
