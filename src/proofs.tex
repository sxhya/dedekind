\usepackage{mathtools}Throughout this section we also denote by $\lambda_a$ the morphism of principal localization at $a \in A$.
...
\begin{lemma}[Dilation principle]\label{lem:dp-2}
...
\begin{proof}
    ...
    $\iota \cdot \lambda_X^{rel}(\widetilde{x}) = \lambda_X^* (j(x_0) \cdot x)$. %TODO: More details
